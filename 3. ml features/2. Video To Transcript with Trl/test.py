...
def save_to_pdf(filename, content, font_path="NotoSans-Regular.ttf", rtl=False):
    """
...
if __name__ == "__main__":
    input_file = "recording 06012025 151810.mp4"  # Replace with your MP4 file path
    ...
    for lang_code, translation in translations.items():
        ...
        save_to_pdf(translation_file, translation, font_path=font_path, rtl=rtl)
